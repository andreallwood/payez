            ...
            dataSource: [
                {
                    title: Frequency2,
                    template() {
                        return $("<div id='Frequency2DataGrid'>").dxDataGrid({
                            ...
                            filterValue: [['periodstatus', '=', 'Closed']],
                            width: '100%',
                            height: '100dvh',
                            headerFilter: {
                                visible: true,
                            ...
                            onToolbarPreparing: function (e) {
                                e.toolbarOptions.items.unshift({
                                    ...
                                    options: {
                                        ...
                                        onClick: function () {
                                            const dataGrid = $('#Frequency2DataGrid').dxDataGrid('instance');
                            ...
                            onRowUpdated: function (data) {
                                var dataGrid = $("#Frequency2DataGrid").dxDataGrid("instance");
...
// Helper function to insert hyphens in a string
